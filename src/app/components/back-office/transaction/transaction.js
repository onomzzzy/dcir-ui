...
export function Transaction() {
    ...
    const chargeTypeView = () => {
        ...
        switch (currentIndex) {
            ...
            case 1:
                return <CustomTable isReload={true} totalPages={totalPages} totalItems={totalItems}
                                    currentPage={currentPage} range={range} emptyText={emptyText} search={search}
                                    reload={reload} error={error} items={transactions} headers={tableHeaders}/>
            case 2:
                return (
            ...
            case 3:
                return (
                    <div className="p-mt-2">
                        <TransactionBreakdown responseCode={responseCode} transactionSearchKey={transactionSearchKey} goBack={goBack}
                                              detials={details} mobile={isMobileTransaction}/>
                    </div>
                )
                ...
                <div className="p-grid">
                    ...
                    <div className="p-col-5">
                        <div className="p-grid">
                            ...
                            <div className="p-col-6">
                                <div
                                    className={HELPER.HAS_AUTHORITY('dcir_view_transactions') && currentIndex === 1 ? 'dcir-show' : 'dcir-hide'}>
                                    <button disabled={(loading || transactions?.length === 0)}
                                            onClick={() => openModal(1, false)} className="primary-button">
                ...
                <div className="p-grid">
                    ...
                    <div className="p-col-3">
                        <div className="floating-mobile-buttons add-cursor">
                            <div
                                className={HELPER.HAS_AUTHORITY('dcir_view_transactions') && currentIndex === 1 ? 'dcir-show' : 'dcir-hide'}>
                                <i onClick={(e) => op.current.toggle(e)} className="pi pi-ellipsis-v"
                                   style={{'fontSize': '1.5em', 'color': '#464DF2'}}/>
                                <OverlayPanel ref={op} id="overlay_panel" style={{width: '100px'}}
                                              className="overlaypanel-demo">
                                    <div className="p-mb-2 p-ml-1"><span onClick={() => openModal(1, true)}
                                                                         className="custom-over-flow-text"><i
                                        className="pi pi-filter"/> Filter</span></div>
                                </OverlayPanel>
                            </div>
                        </div>
                    </div>
